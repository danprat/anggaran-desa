<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('realisasi.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <select id="kegiatan_id" 
                                    ...
                                    @foreach($kegiatanList as $kegiatan)
                                        <option value="{{ $kegiatan->id }}" 
                                                ...
                                                data-realisasi="{{ $kegiatan->getTotalRealisasi() }}"
                                                data-sisa="{{ $kegiatan->getSisaAnggaran() }}"
                            ...
                            <!-- Info Kegiatan -->
                            <div id="kegiatan-info" class="md:col-span-2 hidden">
                                <div class="bg-blue-50 border border-blue-200 rounded-md p-4">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                                        ...
                                        <div>
                                            <span class="text-blue-600">Total Realisasi:</span>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="deskripsi" 
                                          ...
                                          rows="4"
                                          class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                          placeholder="Deskripsi detail realisasi anggaran...">{{ old('deskripsi') }}</textarea>
                            </div>

                            <!-- Upload Bukti -->
                            <div class="md:col-span-2">
                                <label for="bukti_files" class="block text-sm font-medium text-gray-700 mb-1">
                                    Upload Bukti (PDF, JPG, PNG - Max 5MB per file)
                                </label>
                                <input type="file" 
                                       id="bukti_files" 
                                       name="bukti_files[]" 
                                ...
                                <p class="mt-1 text-sm text-gray-500">
                                    Anda dapat memilih beberapa file sekaligus. Format yang didukung: PDF, JPG, PNG.
                                </p>
                            </div>
                        </div>
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-2 text-sm text-yellow-700">
                                        <ul class="list-disc list-inside space-y-1">
                                            <li>Pastikan jumlah realisasi tidak melebihi sisa anggaran kegiatan</li>
                                            <li>Upload bukti pendukung seperti nota, kwitansi, atau foto kegiatan</li>
                                            <li>Realisasi akan dicatat dalam log aktivitas untuk audit</li>
    ...
    <script>
        ...
        // Initialize if kegiatan already selected
        if (document.getElementById('kegiatan_id').value) {
            updateKegiatanInfo();
        }
    </script>
</x-app-layout>
